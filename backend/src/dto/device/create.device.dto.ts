...
export class CreateDeviceDto {
  ...
  @IsOptional()
  @IsEnum(DeviceStatus, { message: `Status must be one of the following values: ${Object.values(DeviceStatus).join(', ')}` })
  status?: DeviceStatus;

  @IsOptional()
  @Type(() => Date)
  @IsDate({ message: "Acquisition Date must be a valid date format (YYYY-MM-DD)" })
